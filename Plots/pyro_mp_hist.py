...
# Setup logging
logging.basicConfig(level=logging.INFO, filename='hist.log', filemode='w',
...
def main():
    ...
    try:
        # Read the merged parquet file using dask, filtering out zeros in 'pyro2' and 'mp_intensity'
        ...
        ax.set_title('2D Histogram of Pyrometer Voltage and Meltpool Intensity')
